        ...
        <div className="contact-container">
          ...
          <div className="contact-info-box">
            ...
            <ul className="info-list">
              ...
              <li><i className="fas fa-phone"></i> +91 96259 45041</li>
            ...
            <div className="social-icons">
              ...
              <a href="https://wa.me/919625945041?text=Hello%20I%20am%20interested%20in%20your%20services" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a>
            </div>
          </div>
        </div>
      </section>
